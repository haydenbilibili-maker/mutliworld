...
import {
  ...
  getCoralReefsForRegion,
  getMarineLifeForRegion,
  getUnderseaWondersForRegion,
  getMigrationRoutesForRegion,
  oceanPointsToFeatures,
  oceanCurrentsToFeatures,
  oceanRoutesToFeatures,
...
function oceanLayersToFeatures(
  ...
  return [
    ...
    ...oceanPointsToFeatures(getCoralReefsForRegion(regionId), 'coral_reefs', active, generatedAt),
    ...oceanPointsToFeatures(getMarineLifeForRegion(regionId), 'marine_life', active, generatedAt),
    ...oceanPointsToFeatures(getUnderseaWondersForRegion(regionId), 'undersea_wonders', active, generatedAt),
    ...oceanRoutesToFeatures(getMigrationRoutesForRegion(regionId), 'migration_routes', active, generatedAt, '#34d399'),
