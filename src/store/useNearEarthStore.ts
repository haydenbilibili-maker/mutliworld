...
export type ScalarParam =
  ...
  // 大气
  | 'air_temperature' | 'precipitation' | 'pressure_msl' | 'humidity' | 'cape';
...
export const SCALAR_META: Record<ScalarParam, ScalarMeta> = {
  ...
  pressure_msl: { label: '海平面气压', unit: 'hPa', min: 960, max: 1040, endpoint: '/api/atmo-grid', key: 'pressure_msl', ramp: 'thermal', layer: 'mslp' },
  humidity: { label: '相对湿度', unit: '%', min: 0, max: 100, endpoint: '/api/atmo-grid', key: 'relative_humidity_2m', ramp: 'aqi', layer: 'humidity' },
  cape: { label: '对流有效位能 CAPE', unit: 'J/kg', min: 0, max: 4000, endpoint: '/api/atmo-grid', key: 'cape', ramp: 'thermal', layer: 'cape' },
};
