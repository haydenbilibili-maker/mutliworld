...
const EE_KEY_EVENTS: EventDetail[] = [
  ...
  },
  {
    ...
    impact_level: 'high',
    category: 'frontline',
    description: '俄边境州遭跨境袭击频率上升（种子/示例）',
  },
  {
    ...
    category: 'nuclear',
    description: 'IAEA 呼吁建立安全区（种子/示例）',
  },
  {
    id: 'ee-evt-dnipro',
    title: '第聂伯罗 · 导弹袭击预警',
  ...
  },
  {
    ...
    impact_level: 'high',
    category: 'outages',
    description: '变电站修复与西方设备援助（种子/示例）',
  },
  {
    id: 'ee-evt-blacksea',
    title: '黑海 · 俄乌海上对峙',
...
const EE_INCIDENTS: Incident[] = [
  ...
  },
  {
    ...
    faction: 'nato',
    location: { lat: 50.45, lng: 30.52 },
    description: '西方援乌战斗机首批投入作战（种子/示例）',
    source: 'seed/示例',
  },
  {
    id: 'ee-inc-grain',
