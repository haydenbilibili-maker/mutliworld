...
// ───────────────────────────────────────────────────────────────
// econ_hubs 增密（金融/贸易/产业枢纽补全）
// ───────────────────────────────────────────────────────────────
export const DENSIFY_ECON_HUBS_R3: ThematicPoint[] = [
  { id: 'r3-hub-frankfurt', name: '法兰克福 · 金融城', layerId: 'econ_hubs', lng: 8.68, lat: 50.11, note: 'ECB/德交所/德意志银行', impact: 'high' },
  { id: 'r3-hub-zurich', name: '苏黎世 · 金融中心', layerId: 'econ_hubs', lng: 8.54, lat: 47.37, note: '瑞银/瑞信/保险重镇', impact: 'high' },
  { id: 'r3-hub-chicago', name: '芝加哥 · 金融与期货', layerId: 'econ_hubs', lng: -87.63, lat: 41.88, note: 'CME/CBOT 全球衍生品定价中心', impact: 'critical' },
  { id: 'r3-hub-toronto', name: '多伦多 · 金融街', layerId: 'econ_hubs', lng: -79.38, lat: 43.65, note: '加拿大金融中心，五大行总部', impact: 'high' },
  { id: 'r3-hub-tokyo-maru', name: '东京丸之内', layerId: 'econ_hubs', lng: 139.69, lat: 35.68, note: '三菱/三井/瑞穗', impact: 'critical' },
  { id: 'r3-hub-osaka', name: '大阪 · 商业中心', layerId: 'econ_hubs', lng: 135.5, lat: 34.69, note: '关西金融/贸易枢纽', impact: 'high' },
  { id: 'r3-hub-seoul-gang', name: '首尔江南/汝矣岛', layerId: 'econ_hubs', lng: 126.94, lat: 37.52, note: '三星/LG/韩国交易所', impact: 'high' },
  { id: 'r3-hub-mumbai-bkc', name: '孟买 BKC', layerId: 'econ_hubs', lng: 72.88, lat: 19.07, note: '印度金融首都，BSE/RBI', impact: 'high' },
  { id: 'r3-hub-singapore-cbd', name: '新加坡莱佛士坊', layerId: 'econ_hubs', lng: 103.85, lat: 1.28, note: '星展/大华/华侨银行', impact: 'critical' },
  { id: 'r3-hub-sydney-cbd', name: '悉尼 CBD', layerId: 'econ_hubs', lng: 151.21, lat: -33.87, note: 'ASX/澳洲四大行', impact: 'high' },
  { id: 'r3-hub-melbourne', name: '墨尔本金融区', layerId: 'econ_hubs', lng: 144.96, lat: -37.81, note: 'BHP/力拓/矿业融资', impact: 'medium' },
  { id: 'r3-hub-saopaulo-fin', name: '圣保罗保利斯塔大道', layerId: 'econ_hubs', lng: -46.66, lat: -23.56, note: '巴西金融中心，B3 交易所', impact: 'high' },
  { id: 'r3-hub-mexico-pol', name: '墨西哥城波朗科', layerId: 'econ_hubs', lng: -99.2, lat: 19.43, note: '美洲开发银行/BBVA 墨西哥', impact: 'high' },
  { id: 'r3-hub-moscow-cbd', name: '莫斯科城（Moscow City）', layerId: 'econ_hubs', lng: 37.54, lat: 55.75, note: '俄罗斯金融区，受制裁影响', impact: 'high' },
  { id: 'r3-hub-istanbul-levent', name: '伊斯坦布尔 Levent', layerId: 'econ_hubs', lng: 29.01, lat: 41.08, note: '土耳其金融/跨欧亚贸易', impact: 'high' },
  { id: 'r3-hub-dubai-difc', name: '迪拜 DIFC', layerId: 'econ_hubs', lng: 55.28, lat: 25.21, note: '中东金融自由区，离岸金融', impact: 'critical' },
  { id: 'r3-hub-abudhabi-adgm', name: '阿布扎比 ADGM', layerId: 'econ_hubs', lng: 54.37, lat: 24.49, note: '主权基金集聚', impact: 'high' },
  { id: 'r3-hub-riyadh-fc', name: '利雅得 KAFD', layerId: 'econ_hubs', lng: 46.62, lat: 24.76, note: 'King Abdullah 金融区', impact: 'high' },
  { id: 'r3-hub-hongkong-central', name: '中环金融区', layerId: 'econ_hubs', lng: 114.16, lat: 22.28, note: '汇丰/中银/HKEX', impact: 'critical' },
  { id: 'r3-hub-shenzhen-futian', name: '深圳福田 CBD', layerId: 'econ_hubs', lng: 114.06, lat: 22.54, note: '平安/招商/腾讯', impact: 'critical' },
  { id: 'r3-hub-guangzhou-tianhe', name: '广州天河 CBD', layerId: 'econ_hubs', lng: 113.33, lat: 23.13, note: '华南金融中心', impact: 'high' },
  { id: 'r3-hub-beijing-fc', name: '北京金融街', layerId: 'econ_hubs', lng: 116.36, lat: 39.92, note: '一行一局两会/四大行', impact: 'critical' },
  { id: 'r3-hub-shanghai-hongqiao', name: '上海虹桥商务区', layerId: 'econ_hubs', lng: 121.32, lat: 31.2, note: '长三角总部经济', impact: 'medium' },
  { id: 'r3-hub-hangzhou-fintech', name: '杭州 · 金融科技', layerId: 'econ_hubs', lng: 120.16, lat: 30.27, note: '蚂蚁/支付宝总部', impact: 'high' },
  { id: 'r3-hub-johannesburg-sand', name: '约翰内斯堡 Sandton', layerId: 'econ_hubs', lng: 28.05, lat: -26.11, note: '非洲金融中心，JSE', impact: 'high' },
  { id: 'r3-hub-lagos-vi', name: '拉各斯维多利亚岛', layerId: 'econ_hubs', lng: 3.43, lat: 6.43, note: '西非金融/石油公司', impact: 'medium' },
  { id: 'r3-hub-nairobi-west', name: '内罗毕 Upper Hill', layerId: 'econ_hubs', lng: 36.81, lat: -1.3, note: '东非金融/M-Pesa', impact: 'medium' },
  { id: 'r3-hub-warsaw', name: '华沙金融区', layerId: 'econ_hubs', lng: 21.01, lat: 52.24, note: '中东欧金融中心', impact: 'medium' },
  { id: 'r3-hub-telaviv', name: '特拉维夫 · 创新经济', layerId: 'econ_hubs', lng: 34.78, lat: 32.08, note: '创业国度/纳斯达克上市', impact: 'high' },
  { id: 'r3-hub-stockholm-fintech', name: '斯德哥尔摩 · 金融科技', layerId: 'econ_hubs', lng: 18.07, lat: 59.33, note: 'Klarna/iZettle/Spotify', impact: 'medium' },
];

// ───────────────────────────────────────────────────────────────
// datacenters 增密补充（R3 第二批：算力/AI 集群与边缘节点）
// ───────────────────────────────────────────────────────────────
export const DENSIFY_DATACENTERS_R3B: ThematicPoint[] = [
  { id: 'r3-dc-singapore2', name: '新加坡 · 数字车道', layerId: 'datacenters', lng: 103.85, lat: 1.28, note: 'Equinix/NTT 亚太核心', impact: 'high' },
  { id: 'r3-dc-malaysia-jh', name: '柔佛 Kulai', layerId: 'datacenters', lng: 103.6, lat: 1.67, note: '微软/Yondr/新加坡溢出', impact: 'high' },
  { id: 'r3-dc-indonesia-batam', name: '巴淡岛', layerId: 'datacenters', lng: 104.0, lat: 1.05, note: '新加坡近岸溢出', impact: 'medium' },
  { id: 'r3-dc-india-mumbai', name: '孟买 AWS ap-south-1', layerId: 'datacenters', lng: 72.88, lat: 19.08, note: '印度最大云区域', impact: 'high' },
  { id: 'r3-dc-india-chennai', name: '金奈 Azure/谷歌', layerId: 'datacenters', lng: 80.27, lat: 13.08, note: '印度东海岸登陆', impact: 'medium' },
  { id: 'r3-dc-india-hyd', name: '海得拉巴 HY11', layerId: 'datacenters', lng: 78.49, lat: 17.39, note: '微软印度最大园区', impact: 'high' },
  { id: 'r3-dc-japan-inz', name: '东京 INZ', layerId: 'datacenters', lng: 139.77, lat: 35.67, note: '东京互联网交换', impact: 'high' },
  { id: 'r3-dc-korea-pang', name: '板桥科技谷', layerId: 'datacenters', lng: 127.11, lat: 37.39, note: 'AWS/Azure 韩国', impact: 'medium' },
  { id: 'r3-dc-australia-syd2', name: '悉尼西区', layerId: 'datacenters', lng: 150.8, lat: -33.8, note: 'AWS/Azure ap-southeast-2', impact: 'high' },
  { id: 'r3-dc-taiwan-taipei', name: '台北内湖', layerId: 'datacenters', lng: 121.57, lat: 25.07, note: 'GCP/aws 台北', impact: 'medium' },
  { id: 'r3-dc-china-uhqir', name: '乌兰察布', layerId: 'datacenters', lng: 113.13, lat: 41.0, note: '苹果/腾讯/优刻得，绿电', impact: 'high' },
  { id: 'r3-dc-china-nanjing', name: '南京', layerId: 'datacenters', lng: 118.8, lat: 32.06, note: '长三角西翼算力', impact: 'medium' },
  { id: 'r3-dc-china-wuhan', name: '武汉光谷', layerId: 'datacenters', lng: 114.4, lat: 30.5, note: '中部算力枢纽', impact: 'medium' },
  { id: 'r3-dc-china-xian', name: '西咸新区', layerId: 'datacenters', lng: 108.94, lat: 34.34, note: '西部算力节点', impact: 'medium' },
  { id: 'r3-dc-china-chongqing', name: '水土数据中心', layerId: 'datacenters', lng: 106.55, lat: 29.56, note: '腾讯/中国电信西部', impact: 'medium' },
  { id: 'r3-dc-us-pdx', name: '希尔斯伯勒', layerId: 'datacenters', lng: -122.98, lat: 45.52, note: 'Intel/Amazon 俄勒冈', impact: 'high' },
  { id: 'r3-dc-us-boise', name: '博伊西', layerId: 'datacenters', lng: -116.21, lat: 43.62, note: 'Micron/HP 数据中心带', impact: 'medium' },
  { id: 'r3-dc-us-dallas', name: '达拉斯 INFOMART', layerId: 'datacenters', lng: -96.8, lat: 32.78, note: '德州电信酒店集群', impact: 'high' },
  { id: 'r3-dc-us-miami', name: '迈阿密 NAP', layerId: 'datacenters', lng: -80.33, lat: 25.78, note: '拉美海底光缆汇聚点', impact: 'high' },
  { id: 'r3-dc-us-chicago', name: '芝加哥 350 Cermak', layerId: 'datacenters', lng: -87.64, lat: 41.88, note: '中西部电信枢纽', impact: 'high' },
  { id: 'r3-dc-eu-milan', name: '米兰 MIX', layerId: 'datacenters', lng: 9.19, lat: 45.46, note: '南欧互联网交换', impact: 'medium' },
  { id: 'r3-dc-eu-madrid', name: '马德里 Espanix', layerId: 'datacenters', lng: -3.7, lat: 40.42, note: '西班牙/拉美低延迟', impact: 'medium' },
  { id: 'r3-dc-eu-zurich', name: '苏黎世 Equinix', layerId: 'datacenters', lng: 8.54, lat: 47.37, note: '金融低延迟中心', impact: 'medium' },
  { id: 'r3-dc-eu-copenhagen', name: '哥本哈根', layerId: 'datacenters', lng: 12.57, lat: 55.68, note: 'Meta/Apple 北欧新枢纽', impact: 'medium' },
  { id: 'r3-dc-eu-oslo', name: '奥斯陆', layerId: 'datacenters', lng: 10.75, lat: 59.91, note: '挪威水电数据中心', impact: 'low' },
  { id: 'r3-dc-latam-rio', name: '里约', layerId: 'datacenters', lng: -43.2, lat: -22.91, note: '巴西第二云区域', impact: 'medium' },
  { id: 'r3-dc-latam-buenos', name: '布宜诺斯艾利斯', layerId: 'datacenters', lng: -58.38, lat: -34.6, note: 'AWS 南美南部', impact: 'medium' },
  { id: 'r3-dc-me-bahrain', name: '巴林 AWS', layerId: 'datacenters', lng: 50.56, lat: 26.07, note: '中东首个 AWS 区域', impact: 'medium' },
  { id: 'r3-dc-me-kuwait', name: '科威特', layerId: 'datacenters', lng: 47.98, lat: 29.37, note: '海湾云节点', impact: 'low' },
  { id: 'r3-dc-af-nairobi', name: '内罗毕', layerId: 'datacenters', lng: 36.82, lat: -1.29, note: '东非云/Africa Data Centres', impact: 'medium' },
  { id: 'r3-dc-af-lagos2', name: '拉各斯 MDXi', layerId: 'datacenters', lng: 3.38, lat: 6.52, note: '西非主要数据中心', impact: 'medium' },
  { id: 'r3-dc-canada-toronto', name: '多伦多', layerId: 'datacenters', lng: -79.38, lat: 43.65, note: 'AWS/Azure 加东', impact: 'medium' },
  { id: 'r3-dc-canada-montreal', name: '蒙特利尔', layerId: 'datacenters', lng: -73.57, lat: 45.5, note: '水电供能 AI 集群', impact: 'medium' },
];
