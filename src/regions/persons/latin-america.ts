...
export const LATIN_AMERICA_PERSONS = [
  ...
  person('per-la-13', '雅伊尔·博索纳罗', '巴西前总统', '政治', ['latin_america'], BRASILIA[0], BRASILIA[1], '巴西右翼前领导人，2023 年卸任后面临多项司法调查。', { status: 'restricted' }),
  person('per-la-14', '安德烈斯·曼努埃尔·洛佩斯·奥夫拉多尔', '墨西哥前总统', '政治', ['latin_america'], MEXICO_CITY[0], MEXICO_CITY[1], '左翼政治家 AMLO，任内推动社会福利与能源国有化。', { status: 'restricted' }),
  person('per-la-15', '卡洛斯·斯利姆', '墨西哥电信大亨', '经济', ['latin_america'], MEXICO_CITY[0], MEXICO_CITY[1], '美洲电信集团掌门，长期位列全球与拉美首富。', { since: 1990 }),
  person('per-la-16', '丹尼尔·诺沃亚', '厄瓜多尔总统', '政治', ['latin_america'], -78.52, -0.18, '青年企业家出身，主政打击有组织犯罪与安全危机。', { since: 2023 }),
  person('per-la-17', '纳伊布·布克尔', '萨尔瓦多总统', '政治', ['latin_america'], -89.22, 13.69, '以铁腕治安与比特币法币化引发全球关注。', { since: 2019 }),
  person('per-la-18', '莱昂内尔·梅西', '阿根廷足球运动员', '文化', ['latin_america'], -60.64, -32.95, '率阿根廷夺 2022 世界杯，拉美体育文化标志人物。'),
  ...
  person('per-la-22', '内马尔', '巴西足球运动员', '文化', ['latin_america'], -46.63, -23.55, '巴西国家队核心球星，拉美体育全球影响力代表。'),
];
