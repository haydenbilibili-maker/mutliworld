...
export const CHINA_PERSONS = [
  person('per-cn-1', '习近平', '中共中央总书记、国家主席', '政治', ['china'], BJ[0], BJ[1], '中国最高领导人，统筹发展与安全、推进中国式现代化。', { since: 2012 }),
  person('per-cn-2', '李强', '国务院总理', '政治', ['china'], BJ[0], BJ[1], '国务院首脑，负责宏观经济调控与民生政策执行。', { since: 2023 }),
  person('per-cn-3', '王毅', '外交部长', '政治', ['china'], BJ[0], BJ[1], '中国首席外交官，主持中美、中欧及多边外交。', { since: 2023 }),
  person('per-cn-4', '何立峰', '国务院副总理', '经济', ['china'], BJ[0], BJ[1], '分管金融与经贸，协调房地产与地方债务风险化解。', { since: 2023 }),
  person('per-cn-5', '潘功胜', '中国人民银行行长', '经济', ['china'], BJ[0], BJ[1], '货币政策制定者，管理人民币汇率与金融稳定。', { since: 2023 }),
  ...
  person('per-cn-8', '赖清德', '台湾地区领导人', '政治', ['china'], TW[0], TW[1], '民进党籍领导人，强调台湾主体性与防务强化。', { since: 2024 }),
  ...
  person('per-cn-11', '岸田文雄', '日本前首相', '政治', ['china'], TOKYO[0], TOKYO[1], '任内强化防卫预算与对华「战略互惠」框架。', { since: 2021, status: 'restricted' }),
  person('per-cn-12', '李在明', '韩国总统', '政治', ['china', 'asia_pacific'], SEOUL[0], SEOUL[1], '韩国最高行政长官，主张对朝对话与对华合作。', { since: 2025 }),
  person('per-cn-13', '金正恩', '朝鲜劳动党总书记', '政治', ['china'], 125.75, 39.02, '朝鲜最高领导人，推进核导能力与俄朝关系。', { since: 2011 }),
  ...
  person('per-cn-17', '李家超', '香港特别行政区行政长官', '政治', ['china'], HK[0], HK[1], '香港特区首长，负责国安法下治理与经济发展。', { since: 2022 }),
  person('per-cn-18', '贺一诚', '澳门特别行政区行政长官', '政治', ['china'], 113.54, 22.20, '澳门特区首长，推动博彩业转型与横琴合作。', { since: 2019 }),
  person('per-cn-19', '任正非', '华为创始人', '经济', ['china'], SH[0], SH[1], '中国科技企业家，领导华为在通信与芯片领域攻关。', { since: 1987 }),
  person('per-cn-20', '莫言', '诺贝尔文学奖得主', '文化', ['china'], 119.16, 36.71, '中国当代文学代表人物，作品具有世界影响力。', { since: 2012 }),
  person('per-cn-21', '张艺谋', '电影导演', '文化', ['china'], BJ[0], BJ[1], '国际知名导演，主导重大文化活动与影视创作。', { since: 1980 }),
  person('per-cn-22', '钟南山', '呼吸病学专家', '社会', ['china'], 113.26, 23.13, '公共卫生权威，在新冠疫情防治中发挥关键作用。', { since: 2003 }),
