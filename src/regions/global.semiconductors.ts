 ...
 *
 * 均为公开企业资料汇总（厂址近似坐标），非实时产能数据。整理日：2026-06-16
 */
...
export const GLOBAL_SEMICONDUCTORS: SemiconductorFab[] = [
  ...
  { id: 'fab-tsmc-tainan', name: '台南 · TSMC Fab 18', operator: '台积电', lng: 120.27, lat: 23.1, kind: 'foundry', status: 'active', note: '3/5nm 先进制程基地', impact: 'critical' },
  { id: 'fab-tsmc-az', name: '亚利桑那凤凰城 · TSMC', operator: '台积电', lng: -112.13, lat: 33.72, kind: 'foundry', status: 'active', note: '美国先进制程在地化', impact: 'high' },
  ...
  { id: 'fab-samsung-pyeongtaek', name: '平泽 · 三星', operator: '三星电子', lng: 127.05, lat: 37.0, kind: 'memory', status: 'active', note: '全球最大存储+代工园区', impact: 'critical' },
  ...
  { id: 'fab-skhynix-icheon', name: '利川 · SK 海力士', operator: 'SK 海力士', lng: 127.44, lat: 37.27, kind: 'memory', status: 'active', note: 'HBM 高带宽存储核心', impact: 'critical' },
  { id: 'fab-intel-hillsboro', name: '俄勒冈希尔斯伯勒 · Intel', operator: 'Intel', lng: -122.93, lat: 45.54, kind: 'idm', status: 'active', note: 'Intel 先进制程研发主基地', impact: 'high' },
  { id: 'fab-intel-chandler', name: '亚利桑那钱德勒 · Intel', operator: 'Intel', lng: -111.94, lat: 33.06, kind: 'idm', status: 'active', note: '美国本土扩产重点', impact: 'high' },
  ...
  { id: 'fab-smic-shanghai', name: '上海 · 中芯国际', operator: '中芯国际', lng: 121.6, lat: 31.27, kind: 'foundry', status: 'active', note: '中国大陆代工龙头', impact: 'critical' },
  ...
  { id: 'fab-rapidus-chitose', name: '千岁 · Rapidus', operator: 'Rapidus', lng: 141.65, lat: 42.82, kind: 'foundry', status: 'planned', note: '日本 2nm 先进制程合资', impact: 'high' },
  ...
  { id: 'fab-yangtze-nanjing', name: '南京 · 长江存储', operator: '长江存储', lng: 118.8, lat: 32.06, kind: 'memory', status: 'active', note: 'NAND 闪存国产化核心', impact: 'critical' },
  { id: 'fab-cxmt-hefei', name: '合肥 · 长鑫存储', operator: '长鑫存储', lng: 117.28, lat: 31.86, kind: 'memory', status: 'active', note: '中国大陆 DRAM 主力', impact: 'critical' },
